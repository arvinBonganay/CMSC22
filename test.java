...
public class test{	
	...
	// System.out.println(s1.getRadius()); // Upcasted from Circle to Shape. Shape dont have getRadius and Shape doesnt inherit methods of it subclass
	...
	//System.out.println(r2.getSide()); // getSide is from sub class shape
